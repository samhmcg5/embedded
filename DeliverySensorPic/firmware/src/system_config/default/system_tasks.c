...
static void _PERIPHERALS_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for PERIPHERALS Tasks. */
    xTaskCreate((TaskFunction_t) _PERIPHERALS_Tasks,
                "PERIPHERALS Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _PERIPHERALS_Tasks ( void )

  Summary:
    Maintains state machine of PERIPHERALS.
*/
