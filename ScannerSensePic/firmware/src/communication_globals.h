...
#define STR_UPDATE_ZONE_QUOTAS	"{\"SEQ\":%i,\"SCAN_SENSE\":{\"ZONE\":%u,\"RED\":%u,\"GREEN\":%u,\"BLUE\":%u,\"MSGTYPE\":\"%s\"}}!"
#define STR_ZONE_INFO           "{\"SEQ\":%i,\"SCAN_SENSE\":{\"ZONE\":%u,\"RED\":%u,\"GREEN\":%u,\"BLUE\":%u,\"MSGTYPE\":\"%s\"}}!"
