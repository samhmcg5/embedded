...
#define STR_UPDATE_POS      "{\"SEQ\":%i, \"DELIV_NAV\": { \"X\":%i, \"Y\":%i, \"OR\":%u } }!"
...
#define STR_EXECUTING       "{\"SEQ\":%i,\"DELIV_NAV\":{\"STATUS\":1,\"MSG\":\"Task EXECUTING\"}}!"
#define STR_ACK_TASK        "{\"SEQ\":%i,\"DELIV_NAV\":{\"STATUS\":1, \"MSG\":\" TASK RECIEVED\"}}!"
#define STR_ACK_ACT         "{\"SEQ\":%i,\"DELIV_NAV\":{\"STATUS\":2, \"MSG\":\" ACTION RECIEVED\"}}!"
